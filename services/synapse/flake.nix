    ...
    in
    {
      ...
      containers =
        ...
        let
          ...
          matrixAuthRawImageReference = "ghcr.io/element-hq/matrix-authentication-service:1.15.0@sha256:6e1408ebd143184a1d5dac0cf587448d58ee35f66524ba1523ed671671276d7e";
          matrixAuthNixSha256 = "sha256-0XIXF14oJPW3OeEFlh7IFFasFyopONL4cNQQ/c4L2ks=";
          ...
          livekitRawImageReference = "livekit/livekit-server:v1.10.1@sha256:698a13999b4b2285866a32903724884b1e10c03259526391d9b3a72d9b73bbb4";
          livekitNixSha256 = "sha256-yPFuY/2eh6USFVEyvEjUvu1dbRp95EUTQjKJB4XdTb4=";
        ...
        in
        {
          ...
          synapse-app = {
            rawImageReference = "matrixdotorg/synapse:v1.151.0@sha256:184dc8757daef019b511e7f96fc6e5edfb880fd074d8cf702c7e3aa899d188c8";
            nixSha256 = "sha256-V6pQt1MG5tc1Entp4CV8G6MKfLdSgAVYUSmFDmxNTk8=";
            environment = {
          ...
          element-call-jwt = {
            rawImageReference = "ghcr.io/element-hq/lk-jwt-service:0.4.2@sha256:e9174b17c7b0048dba3899e50e2c3a6df8ec97657267a7cefa704076b89d3f96";
            nixSha256 = "sha256-TjojxneqMqiWmGeWXzKmZWHXCzhLAHuK8lzZHL6j/ck=";
            environment = {

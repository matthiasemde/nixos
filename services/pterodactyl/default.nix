...
let
  ...
  panelBaseConfig = {
    rawImageReference = "ccarney16/pterodactyl-panel:v1.15.1@sha256:82407f6dbc259efc64619e4285d0a58089127ce777068913d21062b1cc0dfaee";
    nixSha256 = "sha256-44ikj3B7RccAx0L0E0EoLosHUYlSz5zT181pAKP3J7Q=";
    volumes = [
...
in
{
  ...
  myVirtualization.containers.pterodactyl.database = {
    rawImageReference = "mariadb:13.0.2@sha256:6364857ae6bd6640139189c632df94f76329c7b1402d33fb9e64b05bf1ca628d";
    nixSha256 = "sha256-pT7zlpPfL2RQdfB1Aj5DLeLSMZx0r/DvZssjGNJzpxs=";
    volumes = [
  ...
  myVirtualization.containers.pterodactyl.daemon = {
    rawImageReference = "ccarney16/pterodactyl-daemon:v1.13.3@sha256:25fe474c541a84211c9d0c24742bf477c3442594f4e46333512bb7aa3d0eeb9c";
    nixSha256 = "sha256-eniKTaz4NaHATFpp53DQf20xPMC3gSrrTAX10sOXCFc=";
    networks = [
      backendNetwork
      "frp-ingress"
      "traefik"

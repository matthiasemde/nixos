  ...
  outputs =
    ...
    in
    {
      ...
      containers =
        ...
        {
          grafana = {
            rawImageReference = "grafana/grafana:12.4.3@sha256:2e986801428cd689c2358605289c90ab37d2b39e24808874971f54c99bcdc412";
            nixSha256 = "sha256-5FBUjUcaIw12MJEyalAonEDYI/24RJPzJ4x2Pspb6K0=";
            networks = [
              backendNetwork
              "traefik"
            ];
          ...
          prometheus = {
            rawImageReference = "prom/prometheus:v3.11.0@sha256:dda13e28bf95a5e5ca5b8ed56852006094c1c8e8871d9c9dbeed30aa6e55271f";
            nixSha256 = "sha256-FPabKQ+PxTunUpmgt2QNcWRvx279fccxZDhkhdKa78s=";
            networks = [
              backendNetwork
              "monitoring"
              "traefik"
